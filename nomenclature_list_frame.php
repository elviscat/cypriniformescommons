...
$sql = "SELECT id, nomenclature_announcement FROM nomenclature WHERE status = 'Approved' ORDER BY id DESC LIMIT 0, 5";
...
while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
  ...
  //print "-- <a href=\"nomenclature.php?id=".$row{'id'}."\" target=\"_parent\"><strong>".substr($row{'nomenclature_announcement'}, 0, 100)."...</strong></a><br/>";
